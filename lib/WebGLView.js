...
var WebGLView = function (_React$Component) {
  ...
  function WebGLView() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WebGLView.__proto__ || Object.getPrototypeOf(WebGLView)).call.apply(_ref, [this].concat(args))), _this), _this.ctxId = -1, _this.onSurfaceCreate = function (_ref2) {
    ...
    }, _this.onDrawnFrame = function () {
      if (!_this.props.onDrawnFrame) {
        return;
      }
      _this.props.onDrawnFrame();
  ...
  _createClass(WebGLView, [{
    ...
    value: function componentWillUnmount() {
      ...
      if (this.ctxId > 0) {
        _RNExtension2.default.endLoop(this.ctxId);
      }
    }
  }, {
    key: 'render',
    value: function render() {
      var _props = this.props,
          ...
          onDrawnFrame = _props.onDrawnFrame,
          msaaSamples = _props.msaaSamples,
          viewProps = _objectWithoutProperties(_props, ['onContextCreate', 'onContextFailure', 'onDrawnFrame', 'msaaSamples']);
...
WebGLView.propTypes = _extends({
  ...
  onDrawnFrame: _propTypes2.default.func,
